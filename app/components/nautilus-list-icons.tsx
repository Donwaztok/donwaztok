/** Accent tint for inline meta icons (lists: repos, apps, policies). */
export const listRowMetaIconClass = "shrink-0 text-[var(--pq-accent)]/75";
...
export function IconExternal({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6M15 3h6v6m0 0L10 14" />
    </svg>
  );
}
...
export function IconAppBadge({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="12"
