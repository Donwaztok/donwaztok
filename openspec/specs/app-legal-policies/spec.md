...
Provide publicly accessible privacy policies for Donwaztok mobile apps on the donwaztok site, using a consistent markdown format and URL structure for store compliance and user transparency.
...
- **WHEN** the policy loader reads `tic-tac-toe/privacy.md`
